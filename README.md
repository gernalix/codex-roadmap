...
7. unica eccezione: un `running` locale può diventare terminale se il DB remoto contiene una richiesta terminale autorevole coerente prodotta da `roadmap_finish.py`; `codex-usage` è telemetria e non modifica mai il lifecycle;
