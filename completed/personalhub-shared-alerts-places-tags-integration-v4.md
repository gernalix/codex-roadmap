PROMPT_ID=663657 | PARENT_PROMPT_ID=223103 | project_id=49 | model=GPT-5.6 Terra | reasoning=medium | MegaVault=STANDARD
...
- esegui solo dopo 418844 PASS;
- il lavoro capsule della PR #14 è già in main: non cercare né ricreare `feature/100-capsule-isolation`.
...
# Acceptance / stop
PASS con migration/FK, host+AVD, semantica alert e branch cleanup tutti PASS, e un solo bump versione. Finalizza PROMPT_ID 663657; failure terminali via roadmap_result. Output max 8 righe.
