...
def ensure_schema(conn: sqlite3.Connection) -> None:
    ...
    # PBF (Prompt Blocked/Failed/non-PASS) disposition is derived from the
    # canonical graph and historical evidence. It never rewrites execution
    # outcomes or lifecycle history.
    _ensure_view(
        conn,
        "v_pbf_dispositions",
        """WITH RECURSIVE
