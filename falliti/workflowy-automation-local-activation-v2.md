PROMPT_ID=775412 | project_id=96 | model=GPT-5.6 Luna | reasoning=low | MegaVault=FAST
...
`python3 ~/projects/codex-roadmap/tools/roadmap_finish.py --repo ~/projects/codex-roadmap --prompt-id 775412 --confirm-executed`
