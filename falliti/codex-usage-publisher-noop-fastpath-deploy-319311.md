...
- `PROMPT_ID=319311`
- **Esito:** `BLOCKED`
- **Esecuzione:** 2026-09-18
- **Motivo:** il publisher installato non era eseguibile (`exit 126`).
- Test mirati: PASS.
- Deploy runtime: PASS.
- I due run di benchmark non sono stati eseguiti; il timer non è stato controllato.
