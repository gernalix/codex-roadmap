...
# Esecuzione minima
1. Preflight unico: worktree + un solo fetch `origin main`; richiedi che `51462485da43849c8551da53b2fbc7abb4c678f7` sia antenato del RUN_HEAD, non che HEAD sia identico. Sincronizza/preserva dirty work in modo non distruttivo; per divergenza o overlap usa worktree/branch o riconciliazione sicura in-scope. Blocca solo se il nuovo main rende il goal semanticamente ambiguo o unsafe.
...
# Stop
Dopo PASS:
`python3 ~/projects/codex-roadmap/tools/roadmap_finish.py --repo ~/projects/codex-roadmap --prompt-id 904631 --confirm-executed`
