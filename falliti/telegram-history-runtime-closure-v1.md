...
- fedora-system-monitor task/422308 contiene:
  - f577f66: collector + systemd + test iniziali;
  - 9d736aa: login interattivo corretto quando TELEGRAM_PHONE è vuoto;
  - 5d8ed32: hardening runtime/test aggiuntivi.
- Il worktree ha anche gli ultimi fix non ancora integrati nella baseline 5d8ed32: risoluzione peer Telegram marcato/reale, config read-only sotto ProtectHome, errore locale diagnostico; 6 test mirati PASS.
- Runtime reale:
...
# Esecuzione minima
1. Claim 333860 con roadmap_start.py e usa il worktree restituito.
...
# Acceptance
PASS se il codice del collector è integrabile dal nuovo task senza perdere i fix live, i 6 test PASS, il runtime resta sano, il timer è attivo e il repo dati privato è aggiornato.
