...
Aggiunge un widget di Substances fatto come quello degli Events di Timer. Quando lo aggiungi alla Home scegli a quale pulsante configurato di Substances collegarlo; puoi aggiungerne più di uno, ognuno per una sostanza/azione diversa. Toccandolo dovrà registrare davvero la stessa azione che verrebbe registrata premendo quel pulsante dentro Substances, una sola volta, mantenendo anche le normali regole dello stock e mostrando il toast `<nome> added` solo se la registrazione è riuscita.
