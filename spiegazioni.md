...
| 4 | [[prompts/personalhub-epoch-timestamps-migration]] | La maggior parte di PH dovrebbe già salvare timestamp come epoch(ms); il task è quindi audit-first, non conversione indiscriminata. Resta Codex per scanner locale, eventuale migrazione Room solo delle vere eccezioni TEXT/ISO, formatter globale `EEE d/M/yy HH:mm`, QA timezone/profile e merge sicuro del branch in main dopo PASS. **Prompt**, GPT-5.6 Sol/medium + STRICT. | medium | Prompt |
