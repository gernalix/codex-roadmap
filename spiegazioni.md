...
## 1. [[prompts/personalhub-soldi-account-inclusion-filter-semantics|personalhub-soldi-account-inclusion-filter-semantics]]

Corregge un bug rimasto in Soldi: togliere la spunta a un conto deve escluderlo soltanto dalla somma del denaro posseduto, non far sparire le sue transazioni dalla cronologia. Le transazioni restano quindi sempre consultabili, mentre il totale continua a usare solo i conti selezionati.
...
## 8. [[prompts/personalhub-database-schema-upgrade-safety|personalhub-database-schema-upgrade-safety]]
...
## 10. [[prompts/personalhub-timer-widget-write-result|personalhub-timer-widget-write-result]]
...
## 11. [[prompts/personalhub-timer-session-tag-picker-ux|personalhub-timer-session-tag-picker-ux]]
...
## 12. [[prompts/personalhub-timer-legacy-runtime-cleanup|personalhub-timer-legacy-runtime-cleanup]]
...
## 13. [[prompts/personalhub-complete-module-capsulization|personalhub-complete-module-capsulization]]
...
## 14. [[prompts/personalhub-cross-module-entity-linking|personalhub-cross-module-entity-linking]]
...
## 15. [[prompts/personalhub-places-visit-history-checkin|personalhub-places-visit-history-checkin]]
...
## 16. [[prompts/personalhub-places-sorting-map-navigation|personalhub-places-sorting-map-navigation]]
...
## 17. [[prompts/personalhub-places-geofence-alerts|personalhub-places-geofence-alerts]]
...
## 18. [[prompts/personalhub-autoexport-status-indicator|personalhub-autoexport-status-indicator]]
...
## 19. [[prompts/personalhub-global-screen-version-footer|personalhub-global-screen-version-footer]]
...
## 20. [[prompts/personalhub-dark-theme|personalhub-dark-theme]]
...
## 21. [[prompts/personalhub-global-audit-foundation-safe-undo|personalhub-global-audit-foundation-safe-undo]]
...
## 22. [[prompts/personalhub-global-audit-register-ui|personalhub-global-audit-register-ui]]
