...
| --: | --- | --- | --- | --- |
| 1 | [[prompts/github-autosync-pull-reliability]] | Completa il fix di github-autosync: prima aggiorna il repo runtime, poi fa sì che un branch senza upstream venga ricontrollato dopo un fetch e che il servizio scelga il worktree canonico MegaVault prima di decidere di saltare un repo invariato. Mantiene intatte le protezioni per repo dirty/diverged. | low | Prompt |
