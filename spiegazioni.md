...
Rende realmente utilizzabili gli avvisi di Timer: creazione, modifica, attivazione, disattivazione e cancellazione. Ogni alert deve essere una semplice notifica Android, senza schermate forzate a tutto schermo. Se il testo dell'alert è soltanto un URL, toccare la notifica apre il normale link esterno nel browser oppure, se è un deep link Android gestito da un'altra app installata, apre quell'app. Gli alert attivi vengono inoltre ricostruiti dopo riavvio o aggiornamento senza duplicarsi.
