...
| --: | --- | --- | --- | --- |
| 1 | [[prompts/personalhub-qa-delivery-tooling]] | La toolbox è già in gran parte preparata: restano il recovery/avvio AVD bounded nel preflight, un entrypoint widget canonico e il supporto file-only nel notifier Telegram condiviso. Codex deve completare e verificare solo questi residui locali. | low | Prompt |
