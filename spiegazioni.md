...
| 3 | [[prompts/personalhub-shared-alerts-places-tags-validation]] | **Controllare i nuovi tag e alert di Places.** Il codice è già pronto in un ramo separato e non viene unito a PersonalHub principale. Codex deve costruirlo sul tuo PC, verificare che l'aggiornamento del database non perda dati e provarlo su un telefono Android virtuale: alert entrando o uscendo manualmente da un luogo, alert validi per categorie come “groceries”, apertura diretta dei link e collegamento opzionale a Tasker. I tag di Places devono restare completamente separati da quelli del Timer. Il ramo resta intatto perché lo unirai tu più avanti. **GPT-5.6 Terra/medium + STRICT**. | medium | Prompt |
