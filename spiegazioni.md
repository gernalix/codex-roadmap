...
| --: | --- | --- | --- | --- |
| 1 | [[prompts/personalhub-startup-pixel-verification]] | **Cosa fa:** chiude il blocker startup sul Pixel 8a con tre cold start e, solo se serve, una Perfetto + un fix mirato. **Perché ora:** è un malfunzionamento reale già pre-localizzato; non va mescolato alla successiva CI. | low | Prompt |
