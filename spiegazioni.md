...
## 1. [[prompts/personalhub-hub-context-hardening|personalhub-hub-context-hardening]]

Rifinisce il motore Hub Context appena costruito senza rifarlo da capo. Quando da Giovanni tocchi una sessione, un luogo, una transazione, una sostanza o un'altra entità collegata, “Apri dettaglio” deve arrivare proprio a quell'elemento e non soltanto alla home del modulo. Elimina inoltre query inefficienti che leggono un elemento alla volta, impedisce a Timer/Places di caricare liste enormi in memoria per una ricerca e protegge i template interni di sistema da modifiche accidentali. Chiude il task con prove Android che verificano davvero la destinazione finale.
