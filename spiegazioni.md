...
| 2 | [[prompts/personalhub-timer-now-simplify]] | **Perché è importante:** la schermata principale del Timer è troppo affollata e alcune azioni non sono intuitive. Questo task la semplifica, mette in primo piano ciò che stai facendo adesso e rende molto più evidente come avviare una nuova sessione. Nella stessa sessione emulator chiude anche la QA UI già differita della fase Hub/episodi completata. | low | Prompt |
| 3 | [[prompts/personalhub-places-checkin-attempt-journal]] | **Perché è importante:** quando un check-in in un luogo fallisce, oggi spesso non rimane abbastanza informazione per capire il motivo. Questo task registra ogni tentativo, riuscito o fallito, così la prossima volta potrai sapere con precisione cosa è successo invece di doverlo indovinare. | medium | Goal |
