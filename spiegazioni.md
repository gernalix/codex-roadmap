...
| 3 | [[prompts/personalhub-datasette-lite-offline-runtime]] | La shell del Data Explorer è già in `main` e la specifica ora richiede lo stesso grafo FK/backlink simmetrico in locale e remoto, con `Related across PersonalHub` disponibile da qualunque modulo. Resta la parte locale difficile: vendorizzare Datasette Lite+Pyodide, generare la presentazione effimera peer-to-peer, applicare la UI mobile, provare offline e fare QA/release. **Prompt**, GPT-5.6 Sol/medium + STANDARD. | medium | Prompt |
