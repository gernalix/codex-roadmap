...
| --: | --- | --- | --- | --- |
| 1 | [[prompts/github-autosync-pull-reliability]] | Completa il fix di github-autosync e lo limita rigidamente a 11 repository autorizzati: codex-roadmap, vm_oracle, MegaVault, fedora-system-monitor, codex-usage, github-autosync, PersonalHub, codex-usage-monitor, fedora-t7-backup, amici_fb e salute. Tutti gli altri repo, presenti o futuri, devono essere ignorati senza clone, sync, audit, MegaVault registration o alert. Restano inoltre i fix per upstream dopo fetch e scelta corretta del worktree canonico, mantenendo le protezioni per repo dirty/diverged. | low | Prompt |
