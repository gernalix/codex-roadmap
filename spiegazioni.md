...
| --: | --- | --- | --- | --- |
| 1 | [[prompts/personalhub-soldi-postqa-regression-gate]] | **Cosa fa:** esegue soltanto il test JVM mirato della correzione ricorrenze nello stesso giorno di apertura conto e prova sul Pixel_8a QA la nuova modalità one-shot dell'helper Room. **Perché:** codice, test e helper sono già stati modificati da remoto in chat; restano esclusivamente esecuzione Gradle e ADB/runtime Android locali. | low | Prompt |
