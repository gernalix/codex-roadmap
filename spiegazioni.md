...
| 3 | [[prompts/personalhub-chat-audit-local-verification]] | **Cosa fa:** verifica con Gradle ed emulatore i fix PH già applicati direttamente in chat: gate root, startup/auto-export, back-stack Home, filtri temporali e stock Sostanze. **Perché:** l'implementazione remota è già conclusa; restano soltanto toolchain Android, test reali ed evidenza `.qa`, che richiedono il runtime locale. | medium | Prompt |
