...
## 1. `personalhub-canonical-entity-delete-fk-policy.md`

Serve a evitare che cancellando un luogo vengano creati errori o, peggio, vengano persi dati collegati a quel luogo.

Esempio: se un acquisto del modulo Soldi è associato a un certo negozio o luogo, PersonalHub non deve permettere che la cancellazione di quel luogo faccia sparire o rompa lo storico degli acquisti. L'app dovrà quindi gestire la situazione in modo sicuro, per esempio impedendo la cancellazione e spiegandone il motivo oppure archiviando il luogo.

## 2. `personalhub-soldi-account-filter-lifecycle.md`
...
## 3. `personalhub-people-call-overlay-hardening.md`
...
## 4. `personalhub-timer-widget-write-result.md`
...
## 5. `personalhub-timer-version-autoconsistency.md`
...
## 6. `personalhub-timer-remove-legacy-first-run-backup.md`
...
## 8. `personalhub-remove-idle-polling.md`
...
## 9. `personalhub-complete-module-capsulization.md`
...
## 10. `personalhub-cross-module-shared-entities.md`
...
## 11. `personalhub-cross-module-linked-entities-ui.md`
...
## 12. `personalhub-places-overlap-disambiguation.md`
...
## 13. `personalhub-places-manual-checkin.md`
...
## 14. `personalhub-places-where-was-i.md`
...
## 15. `personalhub-places-sorting-map-navigation.md`
...
## 16. `personalhub-places-geofence-alerts.md`
...
## 17. `personalhub-substances-core-integrity-command-stock-archive.md`
...
## 18. `personalhub-substances-scheduling-intake-interactions-macros.md`
...
## 19. `personalhub-substances-prescriptions-notifications.md`
...
## 20. `personalhub-substances-history-performance.md`
...
## 21. `personalhub-substances-global-import-export-cleanup.md`
...
## 22. `personalhub-substances-ui-navigation-final-qa.md`
...
## 23. `personalhub-autoexport-status-indicator.md`
...
## 25. `personalhub-global-audit-foundation.md`
...
## 26. `personalhub-global-audit-safe-undo.md`
...
## 27. `personalhub-global-audit-register-ui.md`
