...
1. `prompts/05-personalhub-add-soldi-module-normalize-db.md`
...
Soldi viene migrato prima dell'architettura cross-module affinché il task 04 possa progettare relazioni/entità condivise sullo schema effettivo che include anche transazioni, prodotti, catene e altri dati introdotti da Soldi, evitando rework immediato.
