...
Il riesame di `PersonalHub/main` mostra 8 goal pendenti. Le parti già implementate restano incorporate nei prompt per evitare riesplorazione:
...
1. [[prompts/personalhub-places-history-mutation-overlap-regression|personalhub-places-history-mutation-overlap-regression]] — **GPT-5.5 / low / FAST**
...
6. [[prompts/personalhub-people-call-overlay-hardening|personalhub-people-call-overlay-hardening]] — **GPT-5.5 / medium / FAST**
7. [[prompts/personalhub-global-ui-theme-version-backup-status|personalhub-global-ui-theme-version-backup-status]] — **GPT-5.5 / medium / STANDARD**
...
- **Places regression** resta autonoma e prima di tutto: è un malfunzionamento dei write-path fondamentali già pre-localizzato, da correggere senza trascinare altro lavoro Places già completato.
...
- Places viene **prima di ogni altro goal** perché il modulo non riesce attualmente a eseguire normali mutazioni di storico sui dati reali; la causa è già localizzata ed è un fix FAST.
