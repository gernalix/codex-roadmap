PROMPT_ID=200725 | project_id=49 | model=GPT-5.6 Terra | reasoning=medium | MegaVault=FAST
...
# Stop
Dopo PASS:
`python3 ~/projects/codex-roadmap/tools/roadmap_finish.py --repo ~/projects/codex-roadmap --prompt-id 200725 --confirm-executed`
