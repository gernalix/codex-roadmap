...
Ricostruisce minuto per minuto il blackout grafico usando ActivityWatch, il monitor Fedora, journal e coredump del boot precedente, per distinguere GPU, GNOME, Chrome, memoria o hardware senza cambiare nulla sul sistema.
